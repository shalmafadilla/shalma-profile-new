  ...
  <main>
    <section class="main-section">
      ...
      <div class="name">
        ...
        <p>Project Management | Quality Assurance | <br>Product Development | Front-End Development </p>
        <div class="action">
          <div class="cv">
        ...
        <section id="contact-me">
          ...
          <div class="contact-me">
            ...
            <a href="https://x.com/shalmanaff?s=21">
              <img src="/assets/x.png" alt="x" class="img-fluid me-3 mb-3" width="50px">
            </a>
          </div>
        </section>
        
        <footer>&copy;2024-made with 💖 by Shalma Nur Fadilla.</footer>
        </main>
  </template>
